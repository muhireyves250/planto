    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '0.75rem' }}>
        {metrics.map((metric, idx) => {
          ...
          return (
            <div key={idx} style={{ background: 'var(--green-soft)', borderRadius: '12px', padding: '0.75rem', border: '1px solid rgba(16, 185, 129, 0.1)', display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  <div style={{ background: 'white', padding: '0.25rem', borderRadius: '4px', boxShadow: '0 1px 2px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ width: '100%', height: '4px', background: 'white', borderRadius: '99px', overflow: 'hidden', position: 'relative', marginBottom: '0.5rem' }}>
                <div style={{
                  height: '100%',
                  width: `${percent}%`,
